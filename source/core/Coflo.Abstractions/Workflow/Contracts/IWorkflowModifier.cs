...
using Coflo.Abstractions.Primitives;
using Coflo.Abstractions.Primitives.Contracts;
using Coflo.Abstractions.Primitives.Control;
using Coflo.Abstractions.Primitives.Iteration;
using Coflo.Abstractions.Primitives.Recurring;
using Coflo.Abstractions.Steps.Contracts;
using Coflo.Abstractions.Steps.Models;
using ActionStepBody = Coflo.Abstractions.Steps.Models.ActionStepBody;
using InlineStepBody = Coflo.Abstractions.Steps.Models.InlineStepBody;
...

{
    ...
    /// <param name="cancelCondition">A conditon that when true will cancel this WaitFor</param>
    /// <returns></returns>
    IStepBuilder<TData, Activity> Activity(Expression<Func<TData, IStepExecutionContext, string>> activityName,
